jQuery(document).ready(function($) {
    ...
    $('#site-navigation').prepend('<button class="btn-close-menu"><span></span></button>');
        $('#site-navigation ul li.menu-item-has-children').append('<button><i class="fa fa-angle-down"></i></button>');
