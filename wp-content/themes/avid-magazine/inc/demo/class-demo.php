 ...
 * Demo class
 *
 * @package Avid_Magazine
 */

if ( ! class_exists( 'Avid_Magazine_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Avid_Magazine_Demo {

		/**
		 * Singleton instance of Avid_Magazine_Demo.
		 *
		 * @var Avid_Magazine_Demo $instance Avid_Magazine_Demo instance.
		 */
		...
		/**
		 * Main Avid_Magazine_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Avid_Magazine_Demo ) ) {
				self::$instance = new Avid_Magazine_Demo();
