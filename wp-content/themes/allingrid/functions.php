...
if ( ! function_exists( 'allingrid_display_social_sites' ) ) :
	function allingrid_display_social_sites() {
		...
		if ( !empty($socialURL) ) {
			...
			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Facebook', 'allingrid') . '" class="facebook16"></a></li>';
		}

		$socialURL = get_theme_mod('allingrid_social_twitter');
		if ( !empty($socialURL) ) {

			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Twitter', 'allingrid') . '" class="twitter16"></a></li>';
		}

		$socialURL = get_theme_mod('allingrid_social_linkedin');
		if ( !empty($socialURL) ) {

			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on LinkedIn', 'allingrid') . '" class="linkedin16"></a></li>';
		}

		$socialURL = get_theme_mod('allingrid_social_instagram');
		if ( !empty($socialURL) ) {

			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Instagram', 'allingrid') . '" class="instagram16"></a></li>';
		}

		$socialURL = get_theme_mod('allingrid_social_rss');
		if ( !empty($socialURL) ) {

			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow our RSS Feeds', 'allingrid') . '" class="rss16"></a></li>';
		}

		$socialURL = get_theme_mod('allingrid_social_tumblr');
		if ( !empty($socialURL) ) {

			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Tumblr', 'allingrid') . '" class="tumblr16"></a></li>';
		}

		$socialURL = get_theme_mod('allingrid_social_youtube');
		if ( !empty($socialURL) ) {

			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Youtube', 'allingrid') . '" class="youtube16"></a></li>';
		}

		$socialURL = get_theme_mod('allingrid_social_pinterest');
		if ( !empty($socialURL) ) {

			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Pinterest', 'allingrid') . '" class="pinterest16"></a></li>';
		}

		$socialURL = get_theme_mod('allingrid_social_vk');
		if ( !empty($socialURL) ) {

			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on VK', 'allingrid') . '" class="vk16"></a></li>';
		}

		$socialURL = get_theme_mod('allingrid_social_flickr');
		if ( !empty($socialURL) ) {

			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Flickr', 'allingrid') . '" class="flickr16"></a></li>';
		}

		$socialURL = get_theme_mod('allingrid_social_vine');
		if ( !empty($socialURL) ) {

			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Vine', 'allingrid') . '" class="vine16"></a></li>';
		}
...
if ( ! function_exists( 'allingrid_customize_register' ) ) :
	...
	function allingrid_customize_register( $wp_customize ) {
		...
		$wp_customize->add_setting(
			...
			array(
			    'sanitize_callback' => 'allingrid_sanitize_url',
			)
		);
		...
		$wp_customize->add_setting(
			...
			array(
			    'sanitize_callback' => 'allingrid_sanitize_email',
			)
		);
